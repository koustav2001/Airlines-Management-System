...
public class Journey_Details extends JFrame{  //Forth
	...
	String[] items1 =  {"Philippines", "China", "Russia", "United States","Australia","Saudi Arabia"};
	JComboBox comboBox = new JComboBox(items1);
	comboBox.setBounds(150, 100, 150, 27);
	add(comboBox);
		
		
	String[] items2 =  {"Philippines", "China", "Russia", "United States","Australia","Saudi Arabia"};
